...
@section('content')
    <h1 class="text-3xl font-bold mb-6 text-center">Edit Contacts</h1>

    @include('partials.errors')

    <form action="{{ route('contacts.update', $contact['id']) }}" method="POST" class="max-w-lg mx-auto bg-white p-6 rounded shadow-md" onsubmit="return confirm('Are you sure to update this contact?');">
        @csrf
        @method('PUT')
        <div class="mb-4">
