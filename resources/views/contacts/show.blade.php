...
@section('content')
    ...
    <div class="max-w-lg mx-auto bg-white p-6 rounded shadow-md">
        ...
        <p class="mb-2"><strong>Message:</strong> {{ $contact['message'] }}</p>
        ...
        <div class="flex justify-end space-x-2">
            ...
            <form action="{{ route('contacts.destroy', $contact['id']) }}" method="post" onsubmit="return confirm('Are you sure to delete this contact?');">@csrf
                @method('DELETE')
